...
\begin{frame}
  \begin{iblock}{Binary files}
    \centering
    \mode<beamer>{ \includegraphics[width=.55\textwidth]{mos-figs-6-3} }%
    \mode<article>{ \includegraphics[width=.6\textwidth]{mos-figs-6-3} }
  \end{iblock}
\end{frame}
...
\begin{frame}{\texttt{cp} --- {\small With} \texttt{stdio}}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.5\textwidth]{cp-libc-c} }%
...
\begin{frame}{Directories}{Two-level Directory Systems}
  \begin{iblock}{A separate directory for each user}
    \begin{center}
      \mode<beamer>{ \includegraphics[width=.7\textwidth]{mos-figs-6-8} }%
      \mode<article>{ \includegraphics[width=.4\textwidth]{mos-figs-6-8} }
    \end{center}
    \begin{description}
...
\begin{frame}{Directories}{Hierarchical Directory Systems}
  \centering
  \mode<beamer>{ \includegraphics[height=.85\textheight]{mos-figs-6-9} }%
  \mode<article>{ \includegraphics[width=.5\textwidth]{mos-figs-6-9} }
\end{frame}

\begin{frame}{Directories}{Path Names}
  \centering
  \mode<beamer>{ \includegraphics[height=.8\textheight]{cs3} }%
...
\begin{frame}{\ttfamily mkdir(), chdir(), rmdir(), getcwd()}
  \centering
  \mode<beamer>{ \includegraphics[height=.8\textheight]{mkdir-c} }%
...
\begin{frame}
  ...
  \end{description}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.65\textwidth]{file-alloc-chained} }%
...
\begin{frame}{I-node --- FCB in UNIX}
  \begin{minipage}[t]{.4\textwidth}
    \centering
    \mode<beamer>{ \includegraphics[width=1.4\textwidth]{inode-struct2} }%
...
\begin{frame}
  ...
  \end{block}
  \centering
  \mode<beamer>{ \includegraphics[width=.5\textwidth]{file-tables3} }%
...
\begin{frame}{Why File Table?}
  ...
  \label{fig:filetable}
  \centering
  \mode<beamer>{ \includegraphics[width=.6\textwidth]{mos-10-33} }%
